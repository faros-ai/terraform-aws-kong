...
| cloudwatch\_agent\_kong\_config | Cloudwatch Agent Config for Kong | `string` | `"non-existent-parameter"` | no |
| cloudwatch\_agent\_system\_config | Cloudwatch Agent Config for system metrics | `string` | `"non-existent-parameter"` | no |
